-- First, ensure we have the industry and category
INSERT INTO industry (id, name) 
VALUES ('medical', 'Medical & Healthcare')
ON CONFLICT (id) DO NOTHING;

INSERT INTO category (id, name) 
VALUES ('pain-management', 'Pain Management')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO demo (
  ...
  'https://example.com/dr-hassan.jpg', -- Replace with actual photo URL
  '214-423-1352',
