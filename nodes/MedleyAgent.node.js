...
class MedleyAgent {
    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            const contactPhone = (typeof data.contact === 'object' && data.contact && 'phone' in data.contact) ? data.contact.phone :
                    ...
                    const businessContext = {
                        ...
                        industryKnowledge: {
                            healthcare: {
                                ...
                                locations: safeLocations.map((loc) => { var _a, _b, _c, _d; return `${String((_a = loc.name) !== null && _a !== void 0 ? _a : '')}: ${String((_b = loc.address1) !== null && _b !== void 0 ? _b : '')}, ${String((_c = loc.city) !== null && _c !== void 0 ? _c : '')}, ${String((_d = loc.state) !== null && _d !== void 0 ? _d : '')}`; })
                            }
                        }
                    };
                    const llmPayload = {
...
LOCATIONS: ${safeLocations.map((loc) => { var _a, _b, _c, _d; return `${String((_a = loc.name) !== null && _a !== void 0 ? _a : '')}: ${String((_b = loc.address1) !== null && _b !== void 0 ? _b : '')}, ${String((_c = loc.city) !== null && _c !== void 0 ? _c : '')}, ${String((_d = loc.state) !== null && _d !== void 0 ? _d : '')}`; }).join('; ')}
