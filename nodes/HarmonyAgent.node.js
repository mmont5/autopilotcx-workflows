        ...
        for (let i = 0; i < items.length; i++) {
            ...
            const userMessage = (() => {
                if (typeof data.message === 'string')
                    return data.message;
                if (typeof data.body === 'object' && data.body && typeof data.body.message === 'string')
            ...
            const companyName = (() => {
                ...
                if (typeof data.body === 'object' && data.body && typeof data.body.company_name === 'string')
                    return data.body.company_name;
                return "our practice";
            })();
            const agentName = (() => {
                if (typeof data.agent_name === 'string')
                    return data.agent_name;
                if (typeof data.body === 'object' && data.body && typeof data.body.agent_name === 'string')
                    return data.body.agent_name;
                return "your assistant";
            })();
            const industry = (() => {
                if (typeof data.industry === 'string')
                    return data.industry;
                if (typeof data.body === 'object' && data.body && typeof data.body.industry === 'string')
                    return data.body.industry;
                return "healthcare";
            })();
            const category = (() => {
                if (typeof data.category === 'string')
                    return data.category;
                if (typeof data.body === 'object' && data.body && typeof data.body.category === 'string')
                    return data.body.category;
                return "";
            })();
            const locations = (() => {
            ...
            const contactPhone = (() => {
                if (typeof data.contact === 'object' && data.contact && typeof data.contact.phone === 'string')
                    return data.contact.phone;
                if (typeof data.body === 'object' && data.body && typeof data.body.company_phone === 'string')
                    return data.body.company_phone;
                return "";
            })();
            const contactEmail = (() => {
                if (typeof data.contact === 'object' && data.contact && typeof data.contact.email === 'string')
                    return data.contact.email;
                if (typeof data.body === 'object' && data.body && typeof data.body.company_email === 'string')
                    return data.body.company_email;
                return "";
            })();
            ...
            if (hasLocationIntent) {
                const locationInfo = locations.length > 0 ?
                    `\n\nOur Locations:\n${locations.map((loc) => `${loc.address1}${loc.address2 ? ', ' + loc.address2 : ''}, ${loc.city}, ${loc.state} ${loc.zip}`).join('\n')}` :
...
exports.HarmonyAgent = HarmonyAgent;
